...
# "savgol" | "none"
PATH_SAVGOL_WINDOW = 9  # окно должно быть нечетным и >=5
PATH_SAVGOL_POLYORDER = 2
# Полином для фильтра Савицкого–Голея (обычно 2)
...
BARBELL_X_STABILITY_GAIN = 1.5    # >1 усиливает стабильность по X в выборе лучшей окружности
